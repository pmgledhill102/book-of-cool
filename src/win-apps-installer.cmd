...
:: #####################################################################
:: Office
copy win-apps-installer-office-config.xml %temp%\office-config.xml
winget install --id="Microsoft.Office" --exact --silent --override "/download %temp%\office-config.xml"
winget install --id="Microsoft.Office" --exact --silent --override "/configure %temp%\office-config.xml"
winget install --id="Microsoft.VisioViewer" --exact 
...
winget install --id="Amazon.Kindle" --exact --silent
